...
## Описание
SmolXP — это компактная версия Windows XP, предназначенная для использования на компьютерах с низкой производительностью или в качестве одноразовой операционной системы для тестирования. Благодаря небольшому размеру ISO и установочного файла она подходит для использования на старых компьютерах с ограниченными ресурсами. 

 Этот проект был вдохновлен пользовательскими версиями Windows Tiny10 и Tiny11 от NTDEV. 

Невероятно, но SmolXP может работать всего с 24 МБ ОЗУ и 32 МБ видеопамяти.

При установке VMware Tools без файла подкачки и с включенным сжатием он может занимать всего 100–400 МБ на носителе объемом 5 ГБ.

Установка не занимает много времени. В зависимости от характеристик вашего устройства она может занять 3–10 минут. Гораздо быстрее, чем обычная XP.


Версии SmolXP 2.0 x86 и x64 одновременно.
![image](https://github.com/AFellowSpeedrunner/SmolXP/assets/73440604/bed5c63e-f998-444c-ae71-b810e71caadd)

## Программное обеспечение для виртуальных машин, которое может установить и запустить SmolXP
VMware Workstation 17
VirtualBox (гостевые версии не работают должным образом в x64.)

## Известные проблемы, которые можно исправить
### Пока ничего.
## Известные проблемы, которые нельзя исправить
### Гостевые редакции VBox некорректно работают с x64.
 Похоже, это проблема самой Windows XP x64, а не SmolXP x64. Если в SmolXP x86 все работает нормально, то почему не работает в x64? Это не может быть связано с nLite, настройки были бы точно такими же. Поэтому я думаю, что это просто проблема с кодом для XP x64. На данный момент это невозможно исправить, и, вероятно, это никогда не будет исправлено. Используйте VMware или QEMU для полной поддержки x64, используйте VirtualBox, если хотите, но имейте в виду, что у вас не будет надлежащей поддержки.
